...
def test_ensure_polymorphic_objects_are_correctly_build_in_case_of_fully_dereferenced_specs(
    ...
    if use_models:
        ...
        expected_response = [Dog(birth_date=datetime.date(2017, 11, 2), name='name', type='Dog')]
    else:
        expected_response = [dict(birth_date=datetime.date(2017, 11, 2), name='name', type='Dog')]
